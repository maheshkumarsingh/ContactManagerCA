...
namespace Services
{
    public class PersonsService : IPersonService
    {
        ...
        public PersonsService(ICountriesService countriesService, IPersonRepository personRepository, ILogger<PersonsService> logger, IDiagnosticContext diagnosticContext)
        {
